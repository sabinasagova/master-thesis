...
\noindent
\hbox{\hbox to 0.5\hsize{In Prague date 15 July 2026\hss}%
\hbox to 0.5\hsize{\hfil\raisebox{-0.4ex}{\includegraphics[height=4em]{img/signature.png}}\hfil}}
\smallskip

\noindent
\hbox to 0.5\hsize{}%
\hbox to 0.5\hsize{\hfil Author's signature\hfil}
...
% Czech meta-data are mandatory in Czech study programmes; here they are
% included even though the programme is English (requested explicitly).
% Each language block gets its own page, since two full abstracts do not
% fit the template's original single-page layout.
