...
git history (tag `thesis-results`; key files also exported to
[`docs/recovered-artifacts/`](../../../docs/recovered-artifacts/)): the full
...
git history first (see `docs/recovered-artifacts/README.md`).
